...
export enum I18nKey {
  ...
  USAGE$AVERAGE_COST_TITLE = "USAGE$AVERAGE_COST_TITLE",
  USAGE$TOTAL_CONVERSATIONS_TITLE = "USAGE$TOTAL_CONVERSATIONS_TITLE",
  USAGE$TREND_TITLE = "USAGE$TREND_TITLE",
  USAGE$TREND_DESCRIPTION = "USAGE$TREND_DESCRIPTION",
  USAGE$TOP_REPOSITORIES_TITLE = "USAGE$TOP_REPOSITORIES_TITLE",
  USAGE$TOP_REPOSITORIES_DESCRIPTION = "USAGE$TOP_REPOSITORIES_DESCRIPTION",
  USAGE$NO_REPOSITORIES = "USAGE$NO_REPOSITORIES",
  USAGE$NO_REPOSITORY_LABEL = "USAGE$NO_REPOSITORY_LABEL",
  USAGE$EMPTY_TITLE = "USAGE$EMPTY_TITLE",
  USAGE$EMPTY_DESCRIPTION = "USAGE$EMPTY_DESCRIPTION",
  USAGE$ERROR_DESCRIPTION = "USAGE$ERROR_DESCRIPTION",
}
