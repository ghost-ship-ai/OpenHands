...
from openhands.integrations.provider_models import (
    CUSTOM_SECRETS_TYPE as _CUSTOM_SECRETS_TYPE,
)
from openhands.integrations.provider_models import PROVIDER_TOKEN_TYPE
from openhands.integrations.provider_models import (
    CustomSecret as _CustomSecret,
)
from openhands.integrations.provider_models import (
    ProviderToken as _ProviderToken,
)
...
CustomSecret = _CustomSecret
CUSTOM_SECRETS_TYPE = _CUSTOM_SECRETS_TYPE
